...
class SaleORM(TenantBase):
    ...
    user_id = Column(Integer, ForeignKey("users.user_id"))  # shopkeeper
    product_id = Column(Integer, ForeignKey("products.product_id"))
    customer_id = Column(Integer, ForeignKey("customers.customer_id"), nullable=True)  # new
    ...
    customer = relationship("CustomerORM", back_populates="sales")  # new
